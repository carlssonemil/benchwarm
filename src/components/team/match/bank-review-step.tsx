    ...
    <div className="flex flex-col gap-5">
      ...
      {guaranteed.length > 0 && (
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-0.5">
            {guaranteed.map(player => (
              <div key={player.id} className="flex items-center justify-between rounded-lg px-3 py-2 bg-amber-50 dark:bg-amber-900/10">
      ...
      {inPool.length > 0 && (
        <div className="flex flex-col gap-1.5">
          ...
          <div className="flex flex-col gap-0.5">
            {[...inPool].sort((a, b) => b.bank_entries - a.bank_entries).map(player => (
              <div key={player.id} className="flex items-center justify-between rounded-lg px-3 py-2 hover:bg-muted/50">
